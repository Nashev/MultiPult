...
//  Cancel: BOOL;
resourcestring
  rs_AVIExportingAudioStore = 'Экспорт в AVI. Audio save';
  rs_AVIExportingCompressorInit = 'Экспорт в AVI. Compressor init';
  rs_AVIExportingCaption = 'Экспорт в AVI. Запись кадра %0:d из %1:d';
  rs_AVIExportingAudioMerge = 'Экспорт в AVI. Audio merge';
